...
{
	public class TopFavourites : System.Web.UI.Page
	{
		...
		{
			this.ReportGrid.DataSource = Report.TopFavourites(int.Parse(this.TxtTop.Text), int.Parse(this.LstMonthfrom.SelectedItem.Value), int.Parse(this.LstMonthto.SelectedItem.Value), int.Parse(this.TxtYear.Text));
