...
{
	public class ServiceOrderServeDetail : System.Web.UI.Page
	{
		...
		public ServiceOrderServeDetail()
		{
		}
		...
		private void LoadDetail(int menuID)
		{
			string[] strArrays;
			...
			if (dataTable != null && dataTable.Rows.Count > 0)
			{
				...
				this.TxtMenuType.Text = string.Concat(item["menunameenglish"].ToString(), str);
			}
		}
		...
		private void LoadReport()
		{
			...
			{
				dataTable = Business.ServiceOrderServe(this.dayfrom, this.dayto, null, null, null, null, this.menuID.ToString());
			}
			else if (this.pageType == "Month")
			{
				dataTable = Business.ServiceOrderServe(null, null, this.monthfrom, this.monthto, this.yearfrom, null, this.menuID.ToString());
			}
			else if (this.pageType == "Year")
			{
				dataTable = Business.ServiceOrderServe(null, null, null, null, this.yearfrom, this.yearto, this.menuID.ToString());
			}
