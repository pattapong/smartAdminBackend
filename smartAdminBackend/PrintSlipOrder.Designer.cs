...
{
	public class PrintSlipOrder : System.Web.UI.Page
	{
		...
		static PrintSlipOrder()
		{
			PrintSlipOrder.ci = new CultureInfo("en-US");
		}

		public PrintSlipOrder()
		{
		}
		...
		private void CheckDrillDown()
		{
			...
			if (item == "month")
			{
				...
				this.TxtDayTo.Text = dateTime1.ToString("d/M/yyyy", PrintSlipOrder.ci);
		...
		private void LoadReport()
		{
			...
			{
				dataTable = Business.PrintSlipOrder(this.LstType.SelectedItem.Value, this.TxtDayFrom.Text, this.TxtDayTo.Text, null, null, null, null);
			}
			else if (this.PanelMonthly.Visible)
			{
				dataTable = Business.PrintSlipOrder(this.LstType.SelectedItem.Value, null, null, this.LstMonthFrom.SelectedItem.Value, this.LstMonthTo.SelectedItem.Value, this.TxtYear.Text, null);
			}
			else if (this.PanelYearly.Visible)
			{
				dataTable = Business.PrintSlipOrder(this.LstType.SelectedItem.Value, null, null, null, null, this.TxtYearFrom.Text, this.TxtYearTo.Text);
			}
