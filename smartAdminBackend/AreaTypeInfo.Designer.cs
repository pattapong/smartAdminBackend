...
{
	public class AreaTypeInfo : System.Web.UI.Page
	{
		...
		protected Label TxtAreaTypeName;
		...
		private void BtnEdit_Click(object sender, EventArgs e)
		{
			...
			stringBuilder.Append(Pages.Url(this, Pages.MAS_AREATYPE_EDIT_PAGE));
			stringBuilder.Append("?id=");
			stringBuilder.Append(this.areaTypeID);
		...
		{
            SmartAdmin.Data.Master.AreaTypeDelete(this.areaTypeID);
			this.BackPage();
		}
		...
		private void LoadAreaType()
		{
			...
			this.TxtAreaTypeName.Text = (string)item["areatypename"];
		}
