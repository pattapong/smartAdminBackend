...
{
	public class SalesByPayment : System.Web.UI.Page
	{
		...
		static SalesByPayment()
		{
			SalesByPayment.ci = new CultureInfo("en-US");
		}
		...
		private void CheckDrillDown()
		{
			...
			if (item == "month")
			{
				...
				this.TxtDayTo.Text = dateTime1.ToString("d/M/yyyy", SalesByPayment.ci);
		...
		private void LoadReport()
		{
			...
			{
				dataTable = Business.SalesByPayment(this.TxtDayFrom.Text, this.TxtDayTo.Text, null, null, null, null);
			}
			else if (this.PanelMonthly.Visible)
			{
				dataTable = Business.SalesByPayment(null, null, this.LstMonthFrom.SelectedItem.Value, this.LstMonthTo.SelectedItem.Value, this.TxtYear.Text, null);
			}
			else if (this.PanelYearly.Visible)
			{
				dataTable = Business.SalesByPayment(null, null, null, null, this.TxtYearFrom.Text, this.TxtYearTo.Text);
			}
