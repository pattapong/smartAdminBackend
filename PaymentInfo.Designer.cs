...
{
	public class PaymentInfo : System.Web.UI.Page
	{
		...
		protected Label TxtPaymentName;

		protected Label LblPaymentGroup;

		protected Label TxtPaymentGroup;
		...
		private void BtnEdit_Click(object sender, EventArgs e)
		{
			...
			stringBuilder.Append(Pages.Url(this, Pages.MAS_PAYMENT_EDIT_PAGE));
			stringBuilder.Append("?id=");
			stringBuilder.Append(this.paymentID);
		...
		{
            SmartAdmin.Data.Master.PaymentDelete(this.paymentID);
			this.BackPage();
		}
		...
		private void LoadPayment()
		{
			...
			this.TxtPaymentGroup.Text = item["paymentgroupname"].ToString();
		}
