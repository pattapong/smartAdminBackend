...
{
	public class PartyByPeriod : System.Web.UI.Page
	{
		...
		static PartyByPeriod()
		{
			PartyByPeriod.ci = new CultureInfo("en-US");
		}

		public PartyByPeriod()
		{
		}
		...
		private void CheckDrillDown()
		{
			...
			if (item == "month")
			{
				...
				this.TxtDayTo.Text = dateTime1.ToString("d/M/yyyy", PartyByPeriod.ci);
		...
		private void LoadReport()
		{
			...
			{
				dataTable = Business.PartyByPeriod(this.TxtDayFrom.Text, this.TxtDayTo.Text, null, null, null, null);
			}
			else if (this.PanelMonthly.Visible)
			{
				dataTable = Business.PartyByPeriod(null, null, this.LstMonthFrom.SelectedItem.Value, this.LstMonthTo.SelectedItem.Value, this.TxtYear.Text, null);
			}
			else if (this.PanelYearly.Visible)
			{
				dataTable = Business.PartyByPeriod(null, null, null, null, this.TxtYearFrom.Text, this.TxtYearTo.Text);
			}
