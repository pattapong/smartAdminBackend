...
{
	public class SalesByPeriod : System.Web.UI.Page
	{
		...
		static SalesByPeriod()
		{
			SalesByPeriod.ci = new CultureInfo("en-US");
		}

		public SalesByPeriod()
		{
		}
		...
		private void CheckDrillDown()
		{
			...
			if (item == "month")
			{
				...
				this.TxtDayTo.Text = dateTime1.ToString("d/M/yyyy", SalesByPeriod.ci);
		...
		private void LoadReport()
		{
			...
			{
				dataTable = Business.SalesByPeriod(this.TxtDayFrom.Text, this.TxtDayTo.Text, null, null, null, null);
			}
			else if (this.PanelMonthly.Visible)
			{
				dataTable = Business.SalesByPeriod(null, null, this.LstMonthFrom.SelectedItem.Value, this.LstMonthTo.SelectedItem.Value, this.TxtYear.Text, null);
			}
			else if (this.PanelYearly.Visible)
			{
				dataTable = Business.SalesByPeriod(null, null, null, null, this.TxtYearFrom.Text, this.TxtYearTo.Text);
			}
