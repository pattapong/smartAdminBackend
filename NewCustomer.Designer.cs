...
namespace SmartAdmin
{
	public class NewCustomer : System.Web.UI.Page
	{
		...
		static NewCustomer()
		{
			NewCustomer.ci = new CultureInfo("en-US");
		}
		...
		private void CheckDrillDown()
		{
			...
			if (item == "month")
			{
				...
				this.TxtDayTo.Text = dateTime1.ToString("d/M/yyyy", NewCustomer.ci);
		...
		private void LoadReport()
		{
			...
			{
				dataTable = Business.NewCustomer(this.TxtDayFrom.Text, this.TxtDayTo.Text, null, null, null, null);
			}
			else if (this.PanelMonthly.Visible)
			{
				dataTable = Business.NewCustomer(null, null, this.LstMonthFrom.SelectedItem.Value, this.LstMonthTo.SelectedItem.Value, this.TxtYear.Text, null);
			}
			else if (this.PanelYearly.Visible)
			{
				dataTable = Business.NewCustomer(null, null, null, null, this.TxtYearFrom.Text, this.TxtYearTo.Text);
			}
