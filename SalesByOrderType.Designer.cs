...
{
	public class SalesByOrderType : System.Web.UI.Page
	{
		...
		static SalesByOrderType()
		{
			SalesByOrderType.ci = new CultureInfo("en-US");
		}
		...
		private void CheckDrillDown()
		{
			...
			if (item == "month")
			{
				...
				this.TxtDayTo.Text = dateTime1.ToString("d/M/yyyy", SalesByOrderType.ci);
		...
		private void LoadReport()
		{
			...
			{
				dataTable = Business.SalesByOrderType(this.TxtDayFrom.Text, this.TxtDayTo.Text, null, null, null, null);
			}
			else if (this.PanelMonthly.Visible)
			{
				dataTable = Business.SalesByOrderType(null, null, this.LstMonthFrom.SelectedItem.Value, this.LstMonthTo.SelectedItem.Value, this.TxtYear.Text, null);
			}
			else if (this.PanelYearly.Visible)
			{
				dataTable = Business.SalesByOrderType(null, null, null, null, this.TxtYearFrom.Text, this.TxtYearTo.Text);
			}
